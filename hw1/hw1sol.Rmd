...
0. What's the difference between the following two commands?
    ...
    head test2.txt
    ```
**Solution:**The < command directs 'hello, world' from one command to the file "test1.txt".
...
`"$3"` is the second commandline argument. In this command, $3 is 5.
...
**Solution:**
This is my 'runSim.R' code:test with rep=50, seed=203, n=100, dist='gaussian'
```{r}
...
MSE<-paste (mseSampAvg / rep, msePrimeAvg / rep, sep = "," )
MSE
