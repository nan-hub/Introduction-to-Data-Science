...
Too many language, so I just display top ten languages.
```{r}
#unique data
...
firstchart <- chart %>%
  ...
  arrange(CHARTTIME) %>%
  distinct(SUBJECT_ID, .keep_all = TRUE) #first systolic blood pressure 
```
```{r}
